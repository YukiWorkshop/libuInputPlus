...
const std::unordered_map<char, int> uInputPlus::KeyTextStringTableUpper = {
...
const std::unordered_map<std::string, int> uInputPlus::EventCodeStringTable = {
	...
	{"KEY_ROTATE_LOCK_TOGGLE", KEY_ROTATE_LOCK_TOGGLE}, {"KEY_BUTTONCONFIG", KEY_BUTTONCONFIG},
	...
	{"KEY_ASSISTANT", KEY_ASSISTANT}, {"KEY_BRIGHTNESS_MIN", KEY_BRIGHTNESS_MIN},
	...
	{"KEY_ONSCREEN_KEYBOARD", KEY_ONSCREEN_KEYBOARD}, {"KEY_MIN_INTERESTING", KEY_MIN_INTERESTING},
	...
	{"BTN_STYLUS3", BTN_STYLUS3}, {"BTN_TOUCH", BTN_TOUCH}, {"BTN_STYLUS", BTN_STYLUS},
